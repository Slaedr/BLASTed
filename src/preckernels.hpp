...
scalar scalar_ftri(const scalar *const __restrict vals, const index *const __restrict colind, 
...
template <typename scalar, typename index> inline 
scalar scalar_btri(const scalar *const __restrict vals, const index *const __restrict colind, 
