...
void block_relax(Map<const Mattype>& vals, const index *const __restrict bcolind,
		...
		const MatrixBase<Vectype>& xL, const MatrixBase<Vectype>& xU, MatrixBase<Vectype>& y)
{
